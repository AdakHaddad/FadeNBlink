...
\
  ...
  # Create instance: led_fade_blink_0, and set properties
  set block_name led_fade_blink
  set block_cell_name led_fade_blink_0
  if { [catch {set led_fade_blink_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $led_fade_blink_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net led_fade_blink_0_led_pwm [get_bd_pins led_fade_blink_0/led_pwm] [get_bd_ports led_pin]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins led_fade_blink_0/clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins led_fade_blink_0/rst]
  ...
  set_property PFM_NAME {xilinx:KV260:KV260_custom_platform:0.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.CLOCK {pl_clk0 {id "7" is_default "false" proc_sys_reset "" status "fixed" freq_hz "99999001"}} [get_bd_cells /zynq_ultra_ps_e_0]
