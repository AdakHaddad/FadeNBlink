...
(* CORE_GENERATION_INFO = "zynq,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zynq,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=7,da_clkrst_cnt=4,da_zynq_ultra_ps_e_cnt=2,synth_mode=None}" *) (* HW_HANDOFF = "zynq.hwdef" *) 
module zynq
   (led_pin);
  output led_pin;

  wire led_fade_blink_0_led_pwm;
  wire zynq_ultra_ps_e_0_pl_clk0;
  wire zynq_ultra_ps_e_0_pl_resetn0;

  assign led_pin = led_fade_blink_0_led_pwm;
  zynq_led_fade_blink_0_1 led_fade_blink_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .led_pwm(led_fade_blink_0_led_pwm),
        .rst(zynq_ultra_ps_e_0_pl_resetn0));
  zynq_zynq_ultra_ps_e_0_1 zynq_ultra_ps_e_0
